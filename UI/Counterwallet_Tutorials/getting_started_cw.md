...
- [Sending and receiving BTC, XCP, and user-created tokens](#sending-and-receiving-btc-xcp-and-user-created-tokens)
- [Logging in without a keyboard (to avoid malware)](#logging-in-without-a-keyboard-to-avoid-malware)
